...
export const TOUR_STEPS = [
  ...
  { page: "overview", target: "workspace-scope-tabs", eyebrow: "Workspace hierarchy", title: "Pages, sessions and immutable runs stay inside the selected workspace.", body: "Choose Pages to move through this workspace's tools. Choose Runs to see only this workspace's dated sessions and the immutable runs inside each session. Switching workspaces switches the whole scoped tree." },
  ...
  { page: "settings", target: "workspace-lifecycle", eyebrow: "17 · Archive safely", title: "Archive inactive work without deleting evidence.", body: "Archive removes a workspace from the active switcher while keeping its runs and reviews. The archived-workspace manager in Settings can restore it or begin a guarded permanent deletion." },
  { page: "settings", target: "archive-manager", eyebrow: "18 · Restore or delete", title: "Lifecycle controls stay in one clear place.", body: "Restore with one click. Permanent deletion is available only for archived local workspaces and requires the exact workspace name, so evidence is not removed accidentally." },
];
