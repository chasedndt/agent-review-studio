...
export const TOUR_STEPS = [
  ...
  { page: "run", target: "run-execute", eyebrow: "4 · Execute a run", title: "This is the button that creates a new evaluation run.", body: "First choose a dataset case, harness version and runner above it. Then select Run evaluation. The runner creates a fresh artifact bundle and trace; the Review page only displays the result for judgment." },
  { page: "overview", target: "run-lineage", eyebrow: "5 · Preserve lineage", title: "New runs append to a chronological record.", body: "Each node records when it ran and which source, dataset and harness version produced it. Rerunning creates a new node; it never overwrites the baseline." },
  { page: "overview", target: "overview-queue", eyebrow: "6 · Work the queue", title: "The queue separates run state from review state.", body: "Not started, draft, re-review and finished states are separate. Diagnostics expose missing files, parse failures and broken references before you trust a bundle." },
  { page: "review", target: "review-workspace", eyebrow: "7 · Understand before scoring", title: "Review the task boundary, then verify the run.", body: "The candidate text was extracted from the source by the selected runner. It is not automatically true or useful. The paired view keeps each candidate beside its source excerpt, surrounding context, provenance and linked actions." },
  { page: "review", target: "claim-labels", eyebrow: "8 · Classify every claim candidate", title: "Categorical labels create reusable ground truth.", body: "Choose labels such as Supported and relevant, Not a claim, Missing context or Linked action is unrelated. Problem labels require a correction. These per-claim judgments are separate from the five whole-run scores." },
  { page: "review", target: "score-panel", eyebrow: "9 · Score the complete run", title: "Five ratings and one decision describe the result.", body: "After every artifact and claim is checked, score five quality areas from 0–3, choose Pass, Needs revision or Fail, and record the overall correction. Automated evaluator results never fill these human fields." },
  { page: "compare", target: "compare-workspace", eyebrow: "10 · Compare experiments", title: "Baseline and candidate stay side by side.", body: "Compare automated and human signals without rewriting either run. A separate pairwise judgment records whether the baseline, candidate or neither is better for this evaluation goal." },
  { page: "insights", target: "insights-workspace", eyebrow: "11 · Find regressions", title: "Metrics show patterns, not automatic truth.", body: "Use evaluator matrices, failure counts, reviewer agreement and the CI gate to find weak harness versions. Human-reviewed examples remain the product-quality authority." },
  { page: "files", target: "files-workspace", eyebrow: "12 · Inspect every source file", title: "The Files workspace retains the complete bundle.", body: "Filter artifacts, preview readable content and keep binary evidence attached. Generated runs include the original source alongside canonical JSON; imported unknown files are retained instead of silently discarded." },
  { page: "history", target: "history-workspace", eyebrow: "13 · Preserve review lineage", title: "Re-review without erasing history.", body: "A finished review becomes an immutable judgment revision. Re-review creates a linked child revision, so changed opinions and reviewer disagreement stay measurable." },
  { page: "systems", target: "systems-workspace", eyebrow: "14 · Inspect the computer science", title: "See the algorithms, data structures and ML boundary.", body: "The System inspector explains ranking, provenance graphs, immutable lineage, reviewer statistics and regression gates with complexity and Year Two topic links. Backpropagation is clearly marked as future—not implied to be running." },
  { page: "learn", target: "learn-workspace", eyebrow: "15 · Learn the terminology", title: "The field guide explains the system in plain English.", body: "Search agent-harness terminology and use the strategy builder to separate deterministic rules, probabilistic graders and decisions that must remain human." },
  { page: "settings", target: "workspace-lifecycle", eyebrow: "16 · Archive safely", title: "Archive inactive work without deleting evidence.", body: "Archive removes a workspace from the active switcher while keeping its runs and reviews. The archived-workspace manager in Settings can restore it or begin a guarded permanent deletion." },
  { page: "settings", target: "archive-manager", eyebrow: "17 · Restore or delete", title: "Lifecycle controls stay in one clear place.", body: "Restore with one click. Permanent deletion is available only for archived local workspaces and requires the exact workspace name, so evidence is not removed accidentally." },
];
